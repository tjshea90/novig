# CHECKPOINT 343 — read me first, then TASKS.md

**Written:** 2026-09-25T05:56:47Z · **tests:** all 1 fast checks green
**Branch:** `claude/novig-sports-api-setup-o4mlxh` · **builds on:** `900d4be` (this checkpoint is the commit after it)

## Just done
SHIPPED v0.4.0 (code 8): CI 36100221957 green, release 36100439547 green, APK 2.86MB, BUILDLOG recorded, link+screenshots sent to Tj. Fixed stale 'sample data' text in release.yml notes

## Do this next
B2: app Novig key settings + setup flow (management PEM -> Vigilant subaccount -> Keystore P-256 trading::read key), echo test; B3: wire NovigStream into Scanner via hybrid NovigSource
