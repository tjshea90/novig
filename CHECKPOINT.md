# CHECKPOINT 430 — read me first, then TASKS.md

**Written:** 2026-09-26T20:48:26Z · **tests:** all 1 fast checks green
**Branch:** `claude/cno-scanner-enhancements-tj52i1` · **builds on:** `06f134f` (this checkpoint is the commit after it)

## Just done
H8 docs: RESEARCH.md §20, NOVIG_API.md §9.1 (Novig app links), BRIEF.md CNO widget decision, CLAUDE.md surface; overlay permission cached per onStart

## Do this next
H9: full test protocol on the whole app (read every source file, cross-check), fix with failing-first tests, full regression, then ship v0.15.0
