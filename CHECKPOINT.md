...
**Written:** 2026-09-26T03:20:21Z · **tests:** all 1 fast checks green
**Branch:** `claude/positive-ev-betting-research-dkp593` · **builds on:** `29bdca7` (this checkpoint is the commit after it)

## Just done
Logged Tj's 2026-09-26 request (floating widget / picture-in-picture over Novig) as TASKS D1-D3

## Do this next
D1/D2: picture-in-picture mini feed (no special permission, auto-enters on leaving the app); read MainActivity + manifest first
